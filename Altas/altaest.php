...
<?php
if (isset($_POST['cargaest'])) {
    $miest = $_POST['est'];

if (isset($_GET['flag'])) {
    $miflag = $_GET['flag'];
    if ($miflag == 0){
        $vuelta = '/Servicios/abmb/estados.php';
    }
    ...
    $query="INSERT INTO estados (Estado) VALUES ('$miest')";
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>"  method="POST">
                    <table class="table table-bordered">
                        <thead class="thead-cel" style="text-align:center">
                         ...
                         <tbody>
                            <tr>
                                <td><input text="est" name="est" style="width: 100%" placeholder="Estado nuevo"></td>
                            </tr>
                            <tr> 
                                <td>
                                    <button class="btn btn-success" name="cargaest">
                                        CARGAR ESTADO
                                    </button>
                                </td>
                            </tr>
