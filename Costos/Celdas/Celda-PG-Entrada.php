...
$pantalla = 'celdas1';//ojo al cambiar nombre del archivo php
...
<table>
  ...
  <tr>
    <th style="width: 33%" position="center">Celda PG-Entrada</th>
    <th style="width: 33%">Opciones</th>
    <th style="width: 34%">Costos - Precio de Venta</th>
  </tr>
  <tr>
    <td><img src="../../img/PG-Entrada.bmp"></td>
    <td>
      ...
      <form style="padding: 10px" name="miFormulario" action="" enctype="text/plain"> 
        ...
        <br>
        <input type="checkbox" name="interruptor" class="boxes"> <label for="interruptor">Interruptor</label>
        <br>
        <input type="checkbox" name="rele" class="boxes"> <label for="rele">Rele</label>
        <br>
        <input type="checkbox" name="seccionador" class="boxes"> <label for="seccionador">Seccionador</label>
        <br>
        <input type="checkbox" name="tresTi" class="boxes"> <label for="tresTi">3 TI</label>
        <br>
        <input type="checkbox" name="tresTv" class="boxes"> <label for="tresTv">3 TV</label>
        <br> 
        </div>
      </form>
    </td>
