...
$pantalla = 'celdas4';//ojo al cambiar nombre del archivo php
...
<table>
  ...
  <tr>
    <th style="width: 33%" position="center">Celda PE-SF6-375-RC</th>
    <th style="width: 33%">Opciones</th>
    <th style="width: 34%">Costos - Precio de Venta</th>
  </tr>
  <tr>
    <td><img src="../../img/PE-SF6-RC.bmp"></td>
    <td>
      <h4 id="actualizado"> </h4>
      <h6 id="dolar"> </h6>
      <form style="padding: 10px" name="miFormulario" action="" enctype="text/plain"> 
        <div class="boxes">
        <input type="checkbox" name="gabinete" class="boxes" checked> <label for="gabinete">Gabinete Con Mano de Obra</label>
        <br>
        <input type="checkbox" name="divisor" class="boxes" > <label for="divisor">Divisor Capacitivo</label>
        <br>
        </div>
      </form>
    </td>
