...
$pantalla = 'celdas3';//ojo al cambiar nombre del archivo php
...
<table>
  ...
  <tr>
    <th style="width: 33%; position: relative;">Celda B SF6 375 mm -- F3</th>
    <th style="width: 33%">Opciones</th>
    <th style="width: 34%">Costos - Precio de Venta</th>
  </tr>
  <tr>
    <td><img src="../../img/CeldaB-F3.bmp"></td>
    <td>
      ...
      <form style="padding: 10px" name="miFormulario" action="" enctype="text/plain"> 
        ...
        <br>
        <input type="checkbox" name="bobina" class="boxes"> <label for="bobina">Bobina</label>
        <br>
...
<script>
  // Definimos el objeto F3 con los costos de cada parte
  const F3 = {
    gabinete: 761.06,
    seccBC: 2244,
    seccDePat: 910.53,
  ...
  const fechaAct = 'Actualización: ' + F3.fecha;
  document.getElementById("actualizado").innerHTML = fechaAct;

  const dolarfecha = 'Dolar: $ ' + F3.dolar;
