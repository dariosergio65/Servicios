...
$pantalla = 'celdas5';//ojo al cambiar nombre del archivo php
...
<table>
  ...
  <tr>
    <th style="width: 33%" position="center">Celda METALCLAD - Entrada - 17kV 1250A</th>
    <th style="width: 33%">Opciones</th>
    <th style="width: 34%">Costos - Precio de Venta</th>
  </tr>
  <tr>
    <td><img src="../../img/Metalclad-Ent-13-1250.bmp"></td>
    <td>
      <h4 id="actualizado"> </h4>
      <h6 id="dolar"> </h6>
      <form style="padding: 10px" name="miFormulario" action="" enctype="text/plain"> 
        <div class="boxes">
        <input type="checkbox" name="trafoAisInt" class="boxes" checked> <label for="trafoAisInt">Trafos y Aisladores + Interruptor</label>
        <br>
        <input type="checkbox" name="matElectricos" class="boxes" checked> <label for="matElectricos">Materiales Eléctricos</label>
        <br>
        <input type="checkbox" name="chaperio" class="boxes" checked> <label for="chaperio">Chaperío</label>
        <br>
        <input type="checkbox" name="barras" class="boxes" checked> <label for="barras">Barras</label>
        <br>
        <input type="checkbox" name="manodeo" class="boxes" checked> <label for="manodeo">Mano de Obra (260 hs TOTAL)</label>
        <br>
        <input type="checkbox" name="tornilleria" class="boxes" checked> <label for="tornilleria">Tornillería</label>
        <br>
...
<script>
  ...
  const PG = {
    trafoAisInt: 19030.64,
    matElectricos: 3567.57,
    chaperio: 1621.3,
    barras: 4041.1,
    manodeo: 2340,
    tornilleria: 210,
