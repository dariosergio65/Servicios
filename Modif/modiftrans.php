...
include ($rutadb);
include ($rutaheader); 
$vuelve= '/Servicios/abmb/transporte.php';
...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query="UPDATE transportes SET Transporte = '$mitrans' WHERE id = $id";
        $result=mysqli_query($conn,$query);
        ...
        $_SESSION['message'] = "Registro de Transporte actualizado con exito";
            ...
            <div class="card card-body">
                <form action="<?php echo $esta ?>" method="POST">
                    <div class="form-group">
                        <input type="text" name="trans" value="<?php echo $mitrans; ?>" class="form-control">
                    </div>
                    <div class="form-group">
